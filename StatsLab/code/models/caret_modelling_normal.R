...
# NB: Maybe should not be imputing those who are in ICU?
# and those who died
...
#corrplot(cor(numeric_vars[, -1]), method="circle") 
...
model_lgr <- cv.glmnet(x = design.mat[ ,!(colnames(design.mat) == "flag")], y = design.mat[, 'flag'],
...
refit_glmnet <- glmnet(x = design.mat[ ,!(colnames(design.mat) == "flag")], y = design.mat[, 'flag'],
