...
##### PROBLEM HERE - should not use mapping clean #######
...
single_surgery_cases <- operations_grouped_single$research_case_id

operations_single <- op_hosp[op_hosp$research_case_id %in% single_surgery_cases, ]

summary(operations_single) # still some NA

# who died

death_single_surgery <- operations_single %>%
